...
import 'package:store_app/features/feature_auth/presentation/bloc/login_cubit/login_cubit.dart';
...
initSmsRetriever() async {
    await AndroidSmsRetriever.listenForSms().then((value) {
      ...
      BlocProvider.of<LoginCubit>(context).LoadCodeCheck(codeController.text);
    });
  }
                        ...
                        BlocConsumer<LoginCubit, LoginState>(
                          ...
                          listener: (context, state) {
                            if(state.loginDataStatus is LoginDataError){
                              ...
                              CustomSnackBar.showsnack(context, loginDataError.errorMessage, Colors.red);
                            }
                            ...
                            if(state.loginDataStatus is LoginDataCompleted){
                              ...
                              CustomSnackBar.showsnack(context, "کد ورود ارسال شد", Colors.green);
                                            ...
                                            child: ElevatedButton(
                                              ...
                                              onPressed: (){
                                                if (_formKey.currentState!.validate()) {
                                                  BlocProvider.of<LoginCubit>(context).LoadLoginSms(phoneController.text);
                                                }
                                              },
                  ...
                  BlocConsumer<LoginCubit, LoginState>(
                    ...
                    listener: (context, state) {
                      if(state.codeCheckStatus is CodeCheckError){
                        ...
                        CustomSnackBar.showsnack(context, codeCheckError.errorMessage, Colors.red);
                      }
                      ...
                      if(state.codeCheckStatus is CodeCheckCompleted) {
                        ...
                        if(codeCheckCompleted.codeModel.name != null){
                          CustomSnackBar.showsnack(context, codeCheckCompleted.codeModel.name.toString() + " به نیاز خوش آمدید", Colors.green);
                        }
