          ...
          builder: (context, state) {
            ...
            if (state.homeDataStatus is HomeDataCompleted) {
              ...
              HomeModel homeModel = homeDataCompleted.homeModel;
                  ...
                  SuggestionProduct? discountProducts = homeModel.data.suggestionProducts[1];
                  SuggestionProduct? organicProducts = homeModel.data.suggestionProducts[0];
                  SuggestionProduct? thirdProductsList = homeModel.data.suggestionProducts[2];
